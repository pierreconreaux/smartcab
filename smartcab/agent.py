...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # fourth decay function
            self.epsilon=math.cos(self.alpha*self.t)
            # linear function for test
    ...
    def choose_action(self, state):
        ...
        # implement a basic agent simulation
        ...
        if self.learning:
            if random.random() < self.epsilon:
                ...
                best_action = [k for k, v in self.Q[state].items() if v == maxQ]
...
def run():
    ...
    #   n_test     - cosdiscrete number of testing trials to perform, default is 0
